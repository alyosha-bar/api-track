...
const Metrics = (
    { totalReq, errorRate, avgLatency, currentPeriod }
) => {
    return ( 
        <>
            <Card className="w-full border rounded-md border-gray-300 p-4 flex justify-around divide-x divide-gray-300 bg-white">
                {/* Total Requests */}
                <div className="flex-1 px-4 flex flex-col justify-center">
                    ...
                    <>
                        ...
                        { totalReq }
                        <div className="text-green-600 text-xs">requests in {currentPeriod} </div>
                        </h3>
                    </>
                    {/* )} */}
                </div>
                ...
                <div className="flex-1 px-4 flex flex-col justify-center">
                    ...
                    <>
                        ...
                        {errorRate}%
                        <div className="text-red-600 text-xs">in {currentPeriod} </div>
                        </h3>
                    </>
                    {/* )} */}
                </div>
                ...
                <div className="flex-1 px-4 flex flex-col justify-center">
                    ...
                    {avgLatency} ms
                    <div className="text-xs">per request in {currentPeriod} </div>
                    </h3>
                </div>
